...
- At session start, read `NOW.md` — current focus, state, and next steps.
- At the end of a session that made decisions, changed direction, or hit a milestone, update `NOW.md`. Keep it under ~60 lines; git history is the archive.
